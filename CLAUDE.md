...
**The rate and pitch blocks are settled** (rules file, Part 2) -- read them before
touching any rate or pitch control; five sessions each reached a different shape. **No unit locks
