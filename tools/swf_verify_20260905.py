#!/usr/bin/env python3
"""Verify the Sweeping Filter's 2026-09-05 reorder by decoding control NAMES.
...
OLDSRC = ('C:/Users/solst/jsfx-backups/effects-folder-baks/'
          'pre-swf-reorder-20260905/full-feature-sweeping-filter.jsfx')
NEWSRC = 'src/full-feature-sweeping-filter.jsfx'
...
JS = re.compile(r'<JS\s+\S*?full-feature-sweeping-filter\.jsfx')
