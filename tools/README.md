...
| [`morpher_migrate_r26r27_20260916.py`](#the-r26r27-per-plugin-migrations) | the Morpher's 64 to 79, blob resealed and transcoded to 7700107; `apply` writes only what `morpher_r26r27_checks/verify_live.py` passed |
