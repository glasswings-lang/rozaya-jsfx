...
and behaves identically; anything you had saved on it is untouched.)* (**default Hz**) — the suite's canonical four, in the suite's canonical order, as of 2026-09-05 (R20). Bubble rate carries the mode's unit. In **Host x** it means every N beats; bigger is slower.
...
**It is a switch now, not a rule (2026-09-09).** `Drift movement mode`, next to the
