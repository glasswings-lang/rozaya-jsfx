...
**Ramp by (per target, slider 48)** `-5000 to +5000, step 0.01, default 0` (units match the selected target)
...
**Drift up amount (per target, slider 40)** `0.0–5000.0, default 0` (units match target)
...
**Drift down amount (per target, slider 41)** `0.0–5000.0, default 0` (units match target)
