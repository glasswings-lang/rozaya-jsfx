...
**Drift up amount (slider 40)** `0 to 20000, default 0` (units match target)
...
**Drift down amount (slider 41)** `0 to 20000, default 0` (units match target)
...
**Drift period (slider 42, cycles)** `0–1000, default 8, 0 = off`
...
**Drift shape (slider 44)** `Sine / Triangle / Random, default Sine`
