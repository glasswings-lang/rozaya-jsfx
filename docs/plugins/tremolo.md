...
**Ramp by (per target, slider 33)** `-1000 to +1000, step 0.001, default 0` (units match the selected target)
...
**Drift up amount (per target, slider 25)** `0.0–100.0, default 0` (units match target)
...
**Drift down amount (per target, slider 26)** `0.0–100.0, default 0` (units match target)
