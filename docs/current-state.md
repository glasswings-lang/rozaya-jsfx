...
- **R24 batch, 2026-09-11:** Veil, Bubbler, Dapple, Tremolo targets in control order; Tensor's Tremolos, a template and `scattered` carried over. `docs/layouts/r24-small-batch-20260911.md`.
