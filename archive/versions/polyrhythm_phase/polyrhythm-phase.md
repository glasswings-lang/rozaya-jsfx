...
> [Polyrhythm Phase v3 (Note-Based)](../../../docs/plugins/polyrhythm-phase-v3.md) (`polyrhythm_phase_v3.jsfx`),
...
How strongly each voice pulses. **0 dB is the strongest pulse:** a voice dips
...
- **Tremolo amount** *(v2.10)* — wanders how strongly the voices pulse. 0 dB is the strongest, so drifting up makes the pulse stronger.
